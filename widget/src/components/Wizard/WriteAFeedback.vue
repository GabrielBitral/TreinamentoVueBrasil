  ...
  <div class="flex flex-col items-center justify-center w-full my-5">
    ...
    <button
      ...
      :class="{
        ...
        'bg-brand-cian text-white': !submitButtonIsDisabled
      }"
      @click="submitAFeedback"
      class="rounded-lg font-black mt-3 flex flex-col justify-center items-center py-2 w-full cursor-pointer focus:outline-none
